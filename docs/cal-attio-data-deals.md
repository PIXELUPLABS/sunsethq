...
- A unique Attio `replay_intake_key` deduplicates each booking UID / ineligible inquiry. A retry never resets a deal's stage, owner or other sales edits. Permanent Attio 4xx errors are retained as failed jobs; network/429/5xx errors retry.
