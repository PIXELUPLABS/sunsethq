...
export function DataTrustHero() {
  return (
    <section className="relative overflow-hidden border-b border-dashed border-black/8 bg-[#fcfcfc]">
      ...
      {/* The design starts the copy at 198px and the sheet band at 443px, so
          the 32px here is what sits between the two. */}
      <div className="relative flex flex-col items-center px-6 pt-[108px] pb-10 text-center lg:px-0 lg:pt-[198px] lg:pb-8">
        <div className="flex flex-col items-center gap-3 lg:gap-6">
          ...
          <p className="max-w-[495px] text-[14.5px] leading-[1.45] tracking-[-0.37px] text-[#727272] sm:text-base sm:leading-[1.4] sm:tracking-[-0.48px]">
